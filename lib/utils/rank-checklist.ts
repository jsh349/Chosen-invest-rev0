 ...
 *   4. No goals defined     → rank-goal bridge has no context
 *   5. Wealth rank < 40     → allocation may warrant review
 *      (only included if cap not yet reached)
 */
export function getRankChecklist(
  ...
  // Allocation review — only if cap not yet reached
